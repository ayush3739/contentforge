...
ALL_ROLES = {ROLE_ANALYST, ROLE_REVIEWER, ROLE_ADMIN}
...
PERM_APPROVE_REJECT = "approve_reject"
...
PERMISSION_MATRIX: dict[str, Set[str]] = {
    PERM_CREATE_SESSION: {ROLE_ANALYST, ROLE_REVIEWER, ROLE_ADMIN},
    PERM_UPLOAD_SOURCE: {ROLE_ANALYST, ROLE_REVIEWER, ROLE_ADMIN},
    PERM_GENERATE: {ROLE_ANALYST, ROLE_REVIEWER, ROLE_ADMIN},
    PERM_VIEW_VERIFICATION: {ROLE_ANALYST, ROLE_REVIEWER, ROLE_ADMIN},
    PERM_APPROVE_REJECT: {ROLE_REVIEWER, ROLE_ADMIN},
