...
class Artifact(Base, UUIDMixin, TimestampMixin):
    ...
    status: Mapped[str] = mapped_column(String(50), default="generating", nullable=False)  # generating, generated, verified, approved, rejected
...
class VerificationResult(Base, UUIDMixin, TimestampMixin):
    ...
    status: Mapped[str] = mapped_column(String(50), default="pending", nullable=False)  # PASSED, REVIEW_REQUIRED, FAILED
